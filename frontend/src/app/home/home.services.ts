...
export class HomeService {
    ...
    constructor(socketService: SocketService, boardService: BoardService) {
        ...
        this.socketService.on('gameStarted').subscribe((data: any) => { this.onGameStarted() });
    ...
    createRoom(playerName: string, roomId: string, userId: string) {
        this.socketService.emit('createRoom', { playerName, roomId, userId });
    }
    ...
    onGameStarted() {
        ...
        this.gameState.currentUserToPlay = this.localUser();
        this.boardService.setGameState(this.gameState);
        return this.roomId();
    }
